  ...
  return (
    <li className={styles.item} {...props}>
      <div className={styles.wrapper}>
        ...
        <span className={styles.owner}>{product.created_by.display_name}</span>
      </div>

      <div className={styles.decr}>
        <span className={styles.name}>{product.name}</span>
        <span className={styles.quantity}>available {product.quantity_available}</span>
        <span className={styles.price}>{product.initial_price} ETH</span>
      </div>
    </li>
  );
};
